        ...
        <div className={sh.panel}>
          ...
          {pendingCustomers.length === 0 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <Button to="/staff/customers" variant="ghost" size="sm" icon="ArrowRight" style={{ alignSelf: 'flex-start', marginTop: 10 }}>Review all</Button>
            </div>
          )}
        </div>
        ...
        <div className={sh.panel}>
          ...
          {pendingTxns.length === 0 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <Button to="/staff/transactions" variant="ghost" size="sm" icon="ArrowRight" style={{ alignSelf: 'flex-start', marginTop: 10 }}>Review all</Button>
            </div>
          )}
        </div>
      </div>
